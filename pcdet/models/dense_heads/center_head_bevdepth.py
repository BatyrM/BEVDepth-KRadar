...
class CenterHead(nn.Module):
    ...
    def generate_predicted_boxes(self, batch_size, pred_dicts):
        ...
        #print("PRED DICTS:", pred_dicts)

        # print(post_process_cfg.MAX_OBJ_PER_SAMPLE)
        # print(post_process_cfg.NMS_CONFIG.NMS_TYPE)
        # print(post_process_cfg.SCORE_THRESH)
        ...
        for idx, pred_dict in enumerate(pred_dicts):
            ...
            # print("FINAL PRED DICTS:", final_pred_dicts)
    ...
    def forward(self, data_dict):
        spatial_features_2d = data_dict['spatial_features_2d_fpn']
        spatial_features_2d = spatial_features_2d[0]
        x = self.shared_conv(spatial_features_2d)
        # print(spatial_features_2d.size()[2:])
        pred_dicts = []
        ...
        if not self.training or self.predict_boxes_when_training:
            # print("YES, we visited CENTERHEAD.PY GENERATE PREDICTED BOXES", end = " ")
