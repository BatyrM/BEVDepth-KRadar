...
class DepthLSSTransform(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        B, C, H, W = x.size()
        img = x.view(B, -1, C, H, W) # comment this
        
        # BN, C, H, W = x.size() # uncomment this
        # img = x.view(int(BN/6), 6, C, H, W) #uncomment this
        ...
        # batch_size = BN // 6 # uncomment this
        #batch_size = BN // 6 if BN >= 6 else BN
        batch_size = x.size(0) # comment this
