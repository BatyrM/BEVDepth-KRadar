...
class SwinTransformer(nn.Module):
    ...
    def forward(self, batch_dict):
        ...
        # img_tensor = batch_dict['camera_imgs'][0][0]
        # print(img_tensor)
        # img_tensor = img_tensor.view(H, W, -1)
        ...
        # # ori_img = Image.open('/home/ave/Documents/UniTR/data/nuscenes/v1.0-mini/' + batch_dict['image_paths'][0][0])
        # # ori_img.show()

        # ori_img = Image.open(batch_dict['meta'][0]['path']['cam']['front'])
        # ori_img.show()

        # import numpy as np
        # import matplotlib.pyplot as plt
        # depth_map_2d = torch.mean(outs[0][0], dim = 0).detach().cpu().numpy()
        ...
        # plt.colorbar()
        # plt.title("2D Feature Map Visualization")
        # plt.show()
